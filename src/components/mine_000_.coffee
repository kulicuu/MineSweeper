...
module.exports = mine = rr
        ...
        z = path_commands.reduce (acc, i) =>
            ...
            switch i[0]
                when 'M', 'L'
                    ...
                    i_vec = [i[1], i[2]]
                    # t_0 = mm a_transform, i_vec
                    # t_1 = mm M, t_0
                    # t_000 = vec2.transformMat3 vec2.create, i_vec, transform_000
                    # t_001 = vec2.transformMat3 vec2.create, t_000, transform_001
                    ...
                    t_1 = vec2.transformMat3 vec2.create(), t_post, @props.tMat

                    # t_1 = vec2.transformMat3 vec2.create, x_t_001, @props.tMat
    ...
    render: ->
        ...
        f1_x = .5 * @props.tMat[0]
        f1_y = .5 * @props.tMat[4]
        std_dev = .9 * @props.tMat[4]
        i_r = .45 ; o_r = i_r * @props.tMat[0]
        i_r_001 = .35 ; o_r_001 = i_r_001 * @props.tMat[0]
        ov = vec2.transformMat3 vec2.create(), iv, @props.tMat
        svg
            width: '100%'
            height: '100%'
            defs
